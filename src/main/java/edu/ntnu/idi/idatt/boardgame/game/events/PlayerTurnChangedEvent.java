 ...
 * <p>
 * This event contains information about the player whose turn it now is.
 * UI components can observe this event to update the display to indicate
 * whose turn it is and enable controls for that player.
 * </p>
 * 
