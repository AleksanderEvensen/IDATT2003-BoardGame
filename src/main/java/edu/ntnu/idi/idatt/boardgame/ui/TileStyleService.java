...
/**
 * Service class to provide easy access to the tile styling system.
 * This class abstracts away the details of the styling system and provides
 * a simple API for applying styles to tiles.
 */
public class TileStyleService {
    ...
    /**
     * Set a different style applier factory to be used by the service.
     * This allows for switching between different UI frameworks.
     * 
