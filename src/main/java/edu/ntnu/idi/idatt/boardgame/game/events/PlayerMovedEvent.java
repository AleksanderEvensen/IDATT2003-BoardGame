 ...
 * <p>
 * This event contains detailed information about the player movement, including
 * the source and destination tiles, the dice value that triggered the movement,
 * and the actual number of steps moved. UI components can observe this event to
 * animate player movements on the board.
 * </p>
 * 
...
public class PlayerMovedEvent implements GameEvent {
     ...
     */
    public PlayerMovedEvent(Player player, Tile fromTile, Tile toTile, int diceValue, int stepsMoved) {
        this.player = player;
